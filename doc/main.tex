...
%Based on the CSMF for blue centrals they find $\sigma_{\log\,M_*}(M_h \sim 10^{12.16}M_\odot) = 0.122 \pm 0.03$ averaged over two SDSS samples and two group mass difference.

%and kinematics of satellite galaxies to infer a fixed $\sigma_{\log\,M*}$ from the SDSS NYU-VAGC for blue central galaxies. In~\cite{leauthaud2012}, they use weak lesning, galaxy clustering, and galaxy number densities of the COSMOS survey\todo{cite} to constrain $sigma_{\log\,M*}$ for all galaxies. 

In the right, we include $\sigma_{\log\,M_h}$ constraints 
from~\cite{mandelbaum2006a, more2011, velander2013, han2015}. 
...
\item \cite{more2011} use kinematics of satellite galaxies in a dark matter halo to 
    ...
    $\sigma_{\log\,M_h}(M_* \sim 10^{10.5}MaÿC M_\odot) = 0.055 - 0.195$
    for blue centrals.
MaMa
