...
along with constraints from \cite{mandelbaum2006a, conroy2007, velander2013, han2015}. 
\cite{mandelbaum2006a, velander2013} use halo occupation models to analyze galaxy-galaxy 
...
group catalog. Each of these works ultimately measure $M_h$ in $M_*$ bins. We derive 
$\sigma_{\log\,M_h}$ from the uncertainties in these $M_h$ measurements at $M_*$ bin 
$\sim 10^{10}M_\odot$. From \cite{mandelbaum2006a, more2011, velander2013} we have 
...
\begin{comment}
    \bitem
        ...
        \item \cite{velander2013} conducts a stacked galaxy-galaxy weak lensing analysis
