...
%On the left panel of Figure~\ref{fig:sigMstar_duty}, we 
%include~\cite{yang2009, more2011, leauthaud2012, tinker2013, zu2015}. 
%These works mainly derive their $\sigma_{\log\,M_*}$ measurements using some 
%sort of halo occupation based models. \cite{more2011, zu2015} use halo occupation 
...
%use a group catalog constructed from SDSS DR4\todo{cite} to measure 
%$\sigma_{\log\,M_*}$ from the conditional SMF. \cite{yang2009, more2011, tinker2013} 
%measure $\sigma_{\log\,M_*}$ for blue/star-forming galaxies while 
%\cite{leauthaud2012, zu2015} measure $\sigma_{\log\,M_*}$ for all galaxies. As  
%\cite{yang2009, more2011, tinker2013}, however, do not find significantly different
%$\sigma_{\log\,M_*}$ ($< 1\sigma$) between blue/star-forming versus red/quiescent 
%galaxies.
%
On the right panel, we include $\sigma_{\log\,M_h}$ constraints from \cite{more2011}
along with measurements from galaxy-galaxy weak lensing analysis of SDSS~\citep{mandelbaum2006a} 
and CFHTLenS~\citep{velander2013}, satellite kinematics of SDSS~\citep{conroy2007}, 
and of optically selected spectroscopic groups $\mathrm{G}^3\mathrm{Cv5}$ in 
GAMA~\citep{han2015}. \cite{mandelbaum2006a, more2011, velander2013} 
measure $\sigma_{\log\,M_h}$ for blue/star-forming galaxies while~\citep{han2015} 
measure $\sigma_{\log\,M_h}$ for all central galaxies. 
