...
\cite{hahn2017}, at $z \approx 1$, the SMF interpolated between the 
...
the galaxies' $M_*$. As we desribe later in this section, however, we're 
only interested in the snapshots at $z \approx 0.05$ and $1$, respectively. 
Next we describe how we select star forming central galaxies
in our model and how we initalize them. 
...
galaxies~\citep{baldry2006, drory2009, cooper2010, iovino2010, peng2010, geha2012, moustakas2012, kovac2014, hahn2015}.
...
its SF, it remains quiescent on long timescales. In other words, 
all of the central galaxies that we place on the SFMS at $z \sim 0$, 
were also on the SFMS at $z \sim 1$ --- the initial redshift of our
model. 
