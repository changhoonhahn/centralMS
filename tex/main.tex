...
\includegraphics[width=0.6\textwidth]{figs/illustris_sfh.pdf} 
    \caption{Star formation histories of star-forming Illustris galaxies with stellar mass of between $10^{10.5}-10^{10.6}M_\odot$ at $z\sim0$}
\label{fig:illsim}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
at any point. References to the SFHs of Illustris as a good motivation for our 
model SFMS tracing model.}. 
...
Finally, to compare the SMF of our model to the SDSS SMF, we use the following
distance metric: 
\beq
\rho_\Phi = \sum\limits_{M} \left( \frac{\Phi^\mathrm{sim}(M) - \Phi^\mathrm{SDSS}}{\sigma_\Phi(M)}\right)^2.
\eeq
